    ...
    <main className="bg-black text-white min-h-screen font-sans">
      ...
      <nav className="flex justify-between items-center px-10 py-6 border-b border-neutral-800">
        ...
        <div className="hidden md:flex gap-8 text-sm text-violet-300">
          <a className="hover:text-violet-400 transition">Home</a>
          <a className="hover:text-violet-400 transition">About</a>
          <a className="hover:text-violet-400 transition">Projects</a>
          <a className="hover:text-violet-400 transition">Contact</a>
        </div>
      </nav>
      ...
      <section className="px-10 py-24 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="space-y-6">
          ...
          <p className="text-neutral-300 text-lg leading-relaxed">
            Hello I'm Nandin but I like to be called Tsuki.
            I'm 15 years old. I'm learning to become a frontend developer.
          </p>
      ...
      <section className="px-10 py-14 border-t border-b border-neutral-800 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
 ...
 <p>────୨ৎ────</p>
    ...
    <div className="flex flex-col items-center justify-center space-y-4 p-8">
      ...
      <div className="animate-bounce-slow bg-zinc-900 border-2 border-pink-400 p-6 rounded-2xl shadow-[0_0_20px_rgba(244,114,182,0.3)] max-w-xs text-center">
        ...
        <h3 className="text-pink-300 font-mono font-bold text-lg">Currently Coding...</h3>
        <p className="text-zinc-400 text-sm mt-2">
          Turning caffeine into <span className="text-blue-400">JavaScript</span> magic.
        </p>
        ...
        <p className="text-[10px] text-zinc-500 mt-1 uppercase tracking-widest">Brain Power: 75%</p>
      </div>

      <div className="flex gap-8 opacity-50">
        <span className="animate-pulse text-pink-400 text-2xl">✦</span>
        <span className="animate-bounce text-blue-400 text-xl" style={{ animationDelay: '0.5s' }}>✧</span>
        <span className="animate-pulse text-pink-400 text-2xl" style={{ animationDelay: '1s' }}>✦</span>
      </div>
    </div>
      ...
      <footer className="relative py-24 text-center border-t border-neutral-800 overflow-hidden">
        ...
        <p className="text-neutral-400 max-w-xl mx-auto">
          I am still learning. Still building. Still dreaming.
          One day I will become the engineer I imagined 🎀.
        </p>

        <p className="mt-10 text-sm text-neutral-600">
          © 2026 Tsuki — Built with ambition and late night coding(but really tho).
        </p>
      </footer>
